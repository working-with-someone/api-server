...
export const getUserVideoSessions = asyncCatch(async (req: Request, res: Response) => {
    const videoSessions = await userVideoSessionService.getUserVideoSessions({
...
export const getUserVideoSession = asyncCatch(async (req: Request, res: Response) => {
