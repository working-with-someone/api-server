...
const okListResponse = (
  ...
  // Some examples were written as { data: [...] }; normalize to an array payload.
  const extractedData =
    items && typeof items === 'object' && 'data' in items
      ? (items as any).data
      : items;
  const normalizedData = Array.isArray(extractedData)
    ? extractedData
    : [extractedData];
    ...
    content: {
      'application/json': {
        ...
        example: withPagination
          ? { data: normalizedData, pagination: paginationExample }
          : { data: normalizedData },
      },
    },
  };
...
const createdResponse = (description: string, example: responseBody) => ({
  description,
  content: {
    'application/json': {
      schema: { $ref: '#/components/schemas/DataResponse' },
        ...
        responses: {
          '200': okResponse('User profile', {
            data: {
              ...
              username: 'seungho',
              encrypted_password:
                '$2b$10$vgdUCcas6.zozbQoZZb19ujwqMWCpyx5VVo06Xqf4cEIb3RmGsGyS',
            ...
            data: [
              {
                ...
                username: 'Janet75',
                encrypted_password:
                  '$2b$10$PC9wrQ6UDmG2OudJ.vE4BOj76FCd/6xWTs9zDvMaOnvC6u9k7Mn0q',
            ...
            data: [
              {
                ...
                thumbnail_uri:
                  '/media/images/thumbnail-4dbc075d-88af-47ba-b55f-24069d01668a',
              ...
              data: [
                {
                  ...
                  title:
                    'Ulciscor angulus universe ubi crudelis aer terminatio vorax cuppedia usus.',
                  description:
                    'Arcus appono cuppedia cimentarius pectus vinitor demitto basium cariosus. Abeo succedo cubitum cultura suffragium. Inflammatio tergum vivo volutabrum amicitia appello defendo impedit dens acervus.\nTurpis subito ipsam cunctatio cunae contego territo. Abscido alioqui adicio stillicidium desino. Tandem tendo capto vigor comis crux aliqua officia confugo vulgo.',
                  ...
                  organizer: {
                    ...
                    username: 'Raymond73',
                    encrypted_password:
                      '$2b$10$Tej91YxmfqEkRv..4dJsUOwtJM2serRDwOKQhrwytCHLhk8QA9h5a',
                ...
                },
                {
                  ...
                  description:
                    'Terminatio terra bardus condico corrupti pel pecto titulus. Coruscus laboriosam atavus fugiat virgo tibi velut quaerat arcesso. Adduco thymbra expedita amplus truculenter denuncio velit statim uredo.\nIusto sponte tripudio bis amplitudo adhuc. Vobis vulnus vallum tantillus subiungo vetus cursim vinum. Subseco ait nostrum contigo alter viridis umbra deporto defluo vivo.',
                  thumbnail_uri: '/media/images/default/thumbnail',
                  status: 'READY',
                  access_level: 'PUBLIC',
                  ...
                  organizer: {
                    ...
                    username: 'Evan80',
                    encrypted_password:
                      '$2b$10$w9dJVE9pSs0JBm6pmkJPoOeLF9SvRoufM.Lq1buSv0lLT6H9COs5u',
            ...
            'Video sessions',
            {
              data: {
                ...
                organizer: {
                  ...
                  encrypted_password:
                    '$2b$10$QyNbADw2l1YuGOnA.T8F4e2QK9rFewUalbmgKbjxaSqaEsjAdjj5e',
